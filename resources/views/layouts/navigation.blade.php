        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Establishments (seulement super-admin) -->
                    @if(auth()->user()->role->name == 'super_admin')
                        <x-nav-link :href="route('establishments.index')" :active="request()->routeIs('establishments.*')">
                            {{ __('Establishments') }}
                        </x-nav-link>
                    @endif
...
--}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()->role->name == 'super_admin')
                <x-responsive-nav-link :href="route('establishments.index')" :active="request()->routeIs('establishments.*')">
                    {{ __('Establishments') }}
                </x-responsive-nav-link>
            @endif
